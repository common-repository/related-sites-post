<?php
/*
Plugin Name:Related Websites (by Blogform)
Plugin URI: http://www.blogform.co.cc/wordpress-plugins/related-websites/
...
License: GPL
*/
/*  Copyright 2008-2009  Blog Traffic Exchange (email : blogform.chetan@gmail.com)
