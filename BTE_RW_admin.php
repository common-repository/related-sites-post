...
function bte_rw_options() {		
	...
	print('
			<div class="wrap">
				<h2>'.__('Related Websites by', 'RelatedSites').' <a href="http://www.blogform.co.cc/">BLOGFORM</a></h2>
				<form id="bte_rw" name="bte_rw_onlinestores" action="'.get_bloginfo('wpurl').'/wp-admin/options-general.php?page=BTE_RW_admin.php" method="post">
					...
					<fieldset class="options">
						<div class="option">
							<p><a href="http://www.blogform.co.cc/">MAKE MONEY FORM YOUR BLOG </a>Easy tips to make money online and make a carrer online .</p><br/>
						...
						<div class="option">
							<p>As an added bonus for claiming your site on the <a href="http://www.blogfrom.co.cc/">BLOGFORM</a>, you can utilize our cutting edge matching and randomizing technology to display related posts from within your own site. Related posts are always listed prior to related websites.</p>
						</div>
						<div class="option">
