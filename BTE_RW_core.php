...
function bte_rw_get_links($num=0) {
	...
	$sitestr = "$linksTitle";
	if ($linksLinktitle){
		$sitestr = '<a href="http://www.blogform.co.cc/wordpress-plugins/related-websites/">'.$sitestr.'</a>';
	}
	
	$linksicon = get_option('bte_rw_links_icon'); 
	if ($linksicon!=null && $linksicon!="") {
		$sitestr = '<a STYLE="border:none;text-decoration:none;outline:none;" href="http://www.blogform.co.cc"><img border="0" alt="HOW TO MAKE MONEY ONLINE" src="'.$home.'/wp-content/plugins' . $base.'/'.get_option('bte_rw_links_icon').'"></a> '.$sitestr;
	}
	...
	foreach ($links as $link) {
		...
		if ($bte_rw_links_img) {
			...
			if ($img != '') {
				...
				$sitestr .= '<img  class="imgbte" hspace="5" align="left" width="100" alt="BLOGFORM" title="BLOGFORM" border=0  src="'.$bte_rw_links_img_default.'"/>';
			} 	
		}
...
function bte_rw_get_posts($num=0) {
	...
	$webstr = "$linksTitle";
	if ($linksLinktitle) {
		$webstr = '<a href="http://www.blogform.co.cc/wordpress-plugins/related-websites/">'.$webstr.'</a>';
	}
	$linksicon = get_option('bte_rw_posts_icon'); 
	if ($linksicon!=null && $linksicon!="") {
		$webstr = '<a STYLE="border:none;text-decoration:none;outline:none;" href="http://www.blogform.co.cc"><img border="0" alt="HOE TO MAKE MONEY ONLINE" src="'.$home.'/wp-content/plugins' . $base.'/'.get_option('bte_rw_posts_icon').'"></a> '.$webstr;
	}
	...
	foreach ($links as $link) {
		...
		if ($bte_rw_posts_img) {
			...
			if ($img != '') {
				...
				$webstr .= '<img  class="imgbte" hspace="5" align="left" width="100" alt="BLOGFORM" title="BLOGFORM" border=0  src="'.$bte_rw_posts_img_default.'"/>';
			} 	
		}
